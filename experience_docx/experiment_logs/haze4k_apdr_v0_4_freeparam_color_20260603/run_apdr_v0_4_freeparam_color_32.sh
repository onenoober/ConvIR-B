...
LOG_DIR="$ROOT/experience_docx/experiment_logs/haze4k_apdr_v0_4_freeparam_color_20260603"
STATUS="$LOG_DIR/status.txt"
TAG=${TAG:-apdr_v0_4_freeparam_color_32_seed3407}
...
log_status "start_freeparam_color root=$ROOT selector=$SELECTOR tag=$TAG"
...
if "$PY" "$ROOT/experience_docx/tools/overfit_haze4k_apdr_v0_4_freeparam_lowcolor.py" \
  ...
  log_status "gate_pass_freeparam_color $TAG"
else
  log_status "gate_fail_freeparam_color $TAG"
fi

log_status "complete_freeparam_color $TAG"
