...
SESSION=${SESSION:-apdr_v04d_spatial_probe_$(date +%Y%m%d_%H%M%S)}
LOG_DIR=${LOG_DIR:-$ROOT/experience_docx/experiment_logs/haze4k_apdr_v0_4d_spatial_coeff_probe_20260603}
RUN_SCRIPT="$ROOT/experience_docx/experiment_logs/haze4k_apdr_v0_4d_spatial_coeff_probe_20260603/run_apdr_v0_4d_spatial_coeff_probe_sigma3.sh"
