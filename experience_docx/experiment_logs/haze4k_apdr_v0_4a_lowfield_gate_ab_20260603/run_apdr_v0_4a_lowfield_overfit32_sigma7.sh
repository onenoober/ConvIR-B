...
SIGMA7_ROOT=${SIGMA7_ROOT:-$ROOT/experience_docx/experiment_logs/haze4k_apdr_v0_4_correctability_traincalib_20260603}
CORR_JSON=${CORR_JSON:-$SIGMA7_ROOT/correctability_traincalib_apdr_v0_4_correctability_traincalib_seed3407.json}
CORR_TRAIN_CSV=${CORR_TRAIN_CSV:-$SIGMA7_ROOT/correctability_traincalib_train_oof_apdr_v0_4_correctability_traincalib_seed3407.csv}
LOG_DIR="$ROOT/experience_docx/experiment_logs/haze4k_apdr_v0_4a_lowfield_gate_ab_20260603"
STATUS="$LOG_DIR/status.txt"
TAG=${TAG:-apdr_v0_4a_lowfield_overfit32_sigma7_seed3407}
...
log_status "start_lowfield_overfit32_sigma7 root=$ROOT selector=$SELECTOR tag=$TAG"
...
if "$PY" "$ROOT/experience_docx/tools/overfit_haze4k_apdr_v0_4a_lowfield.py" \
  ...
  log_status "gate_pass_lowfield_overfit32_sigma7 $TAG"
else
  log_status "gate_fail_lowfield_overfit32_sigma7 $TAG"
fi

log_status "complete_lowfield_overfit32_sigma7 $TAG"
