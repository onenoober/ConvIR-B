...
ROOT=${ROOT:-/root/autodl-tmp/workspace/ConvIR-B-apdr-convir-v0-1}
...
LOG_DIR="$ROOT/experience_docx/experiment_logs/haze4k_apdr_v0_1_20260602"
STATUS="$LOG_DIR/status.txt"

MODEL_NAME=ConvIR-Haze4K-APDR-v0.1-anchor-risk-stop20-seed3407-20260602
TAG=apdr_v0_1_stop20_seed3407_vs_a0
...
"$PY" "$ROOT/experience_docx/tools/preflight_haze4k_apdr.py" \
  --data_dir "$DATA_DIR" \
  --checkpoint "$PRETRAIN" \
  --output "$LOG_DIR/preflight_apdr_v0_1.json" \
  --device cuda \
  --height 256 \
  --width 256 \
  --batch_size 1 \
