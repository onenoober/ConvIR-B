...
Decision: keep the original v2e global safety/LDHN gate as the primary
contract, and keep v2f paused. Do not run F5, v3, RARM, D2, or locked Haze4K
test from this evidence state.
