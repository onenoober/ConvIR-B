...
SESSION=${SESSION:-apdr_v04b_mt_$(date +%Y%m%d_%H%M%S)}
LOG_DIR=${LOG_DIR:-$ROOT/experience_docx/experiment_logs/haze4k_apdr_v0_4b_mapping_triage_20260603}
RUN_SCRIPT="$ROOT/experience_docx/experiment_logs/haze4k_apdr_v0_4b_mapping_triage_20260603/run_apdr_v0_4b_mapping_triage_sigma3.sh"
