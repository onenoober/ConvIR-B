...
export CANDIDATE="$BASE/repos/ConvIR-B-dta-v3-dapc-finetune-v31/Dehazing/ITS/results/ConvIR-Haze4K-DTA-v3-1-WG18LightHinge-seed3407-f0-scout5full/Training-Results/Final.pkl"
bash "$EVID/run_dta_v3_2_ctdg_safemix_audits_convir4090.sh"
CMD
  chmod +x "$hinge_cmd"
