...
REPO=/sda/home/wangyuxin/ConvIR-B/repos/ConvIR-B-haze4k-v5-v2d-chd-rm-need-spatial-hard-negative
PY=/sda/home/wangyuxin/ConvIR-B/envs/convir-cu121/bin/python
OUT=$REPO/experience_docx/experiment_logs/haze4k_v5_chd_rm_v2d_need_spatial_hard_negative_20260709/canary
mkdir -p "$OUT"
LOG=$OUT/v2d_need_spatial_hard_negative_canary.log
exec > >(tee -a "$LOG") 2>&1
...
CUDA_VISIBLE_DEVICES=1 "$PY" experience_docx/tools/run_chd_rm_v2d_need_spatial_hard_negative.py \
  ...
  --v2b_artifact_dir /sda/home/wangyuxin/ConvIR-B/repos/ConvIR-B-haze4k-v5-v2b-chd-rm-need-calibration-repair/experience_docx/experiment_logs/haze4k_v5_chd_rm_v2b_need_calibration_repair_20260708/artifacts \
