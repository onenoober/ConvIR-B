...
utility calibration of aggressive local actions. A corrected A3
failure-decomposition diagnostic confirms the tail is stable across frozen
operators and that aggressive direct-step-energy calibration bins mix oracle
actions too heavily to be safe.
