#!/usr/bin/env python3
"""Aggregate DTA-v3.7 D3 actual TAU soft-blend oracle fold/seed outputs."""
...
def main() -> None:
    ...
    parser.add_argument("--combined_selected_csv", default="v37_tau_real_blend_oracle_selected_all.csv")
    parser.add_argument("--grid_csv", default="v37_tau_real_blend_oracle_grid.csv")
    parser.add_argument("--summary_json", default="v37_tau_real_blend_summary.json")
    ...
    summary = {
        ...
        "phase": "D3_tau_real_soft_blend_aggregate",
        ...
        "decision": "PHASE_D3_TAU_REAL_BLEND_ORACLE_PASS" if strict_rows else "PHASE_D3_TAU_REAL_BLEND_ORACLE_FAIL",
    ...
    print(
        "DTA_V3_7_D3_TAU_REAL_BLEND_AGGREGATE_OK "
