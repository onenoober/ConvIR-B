...
ROUTE_ID = "daytime-dehazing-reside-pairing-contract-v1"
OPERATION_ID = "DAYTIME_DEHAZING_RESIDE_PAIRING_CONTRACT_QUALIFY"
SUMMARY_NAME = "daytime_dehazing_reside_pairing_contract_v1_summary.json"
IDENTITY_NAME = "daytime_dehazing_reside_pairing_contract_v1_identity_summary.json"
REVIEW_FACTS_NAME = "daytime_dehazing_reside_pairing_contract_v1_review_facts.json"
RAW_LEDGER_NAME = "daytime_dehazing_reside_pairing_contract_v1_mapping_ledger.jsonl"
    ...
    if dataset == "ITS":
        specifications = (
            (
                ...
                reside_root / "official/ITS/train/ITS_hazy",
            ),
            (
                "ITS_VALIDATION",
                reside_root / "official/ITS/val/clear",
                reside_root / "official/ITS/val/hazy",
            ),
        )
    else:
        specifications = (
            (
                ...
                reside_root / "official/OTS_ALPHA/hazy_images",
            ),
        )
