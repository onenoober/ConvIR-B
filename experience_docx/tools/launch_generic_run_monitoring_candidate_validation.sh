...
EXPECTED_COMMIT=48203394eaf64a8b1ab4623ff6c130e8c447f0c3
...
tmux new-session -d -s "$SESSION" \
  "env EXPECTED_ROUTE_COMMIT='$EXPECTED_COMMIT' RUNNER_SHA256='$EXPECTED_RUNNER_SHA' MODE='synthetic_validation' REMOTE_REPO='$REMOTE_REPO' RUN_ROOT='/sda/home/wangyuxin/ConvIR-B/runs/generic_run_monitoring_validation_20260716' OUTPUT_PATH='$OUTPUT_PATH' RUN_ID='candidate-48203394e-r4' OUTPUT_ID='candidate-48203394e-r4' GPU='' bash '$REMOTE_REPO/$RUNNER' >>'$OUTPUT_PATH/launch.log' 2>&1"
trap - ERR
