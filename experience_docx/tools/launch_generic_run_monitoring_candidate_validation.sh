...
EXPECTED_COMMIT=7b1ee15804677b0ef89b46e090a68268610ea848
...
REMOTE_REPO=/sda/home/wangyuxin/ConvIR-B/repos/generic-monitoring-candidate-7b1ee1580
OUTPUT_PATH=/sda/home/wangyuxin/ConvIR-B/runs/generic_run_monitoring_validation_20260716/candidate-7b1ee1580-r1
SESSION=convir-generic-monitor-candidate-7b1ee1580
...
tmux new-session -d -s "$SESSION" \
  "env EXPECTED_ROUTE_COMMIT='$EXPECTED_COMMIT' RUNNER_SHA256='$EXPECTED_RUNNER_SHA' MODE='synthetic_validation' REMOTE_REPO='$REMOTE_REPO' RUN_ROOT='/sda/home/wangyuxin/ConvIR-B/runs/generic_run_monitoring_validation_20260716' OUTPUT_PATH='$OUTPUT_PATH' RUN_ID='candidate-7b1ee1580-r1' OUTPUT_ID='candidate-7b1ee1580-r1' GPU='' bash '$REMOTE_REPO/$RUNNER' >>'$OUTPUT_PATH/launch.log' 2>&1"
trap - ERR
