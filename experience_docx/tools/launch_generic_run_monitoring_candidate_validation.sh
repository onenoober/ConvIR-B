...
EXPECTED_COMMIT=33a7722688f7a26b4c025e6c926804987c49c392
...
tmux new-session -d -s "$SESSION" \
  "env EXPECTED_ROUTE_COMMIT='$EXPECTED_COMMIT' RUNNER_SHA256='$EXPECTED_RUNNER_SHA' MODE='synthetic_validation' REMOTE_REPO='$REMOTE_REPO' RUN_ROOT='/sda/home/wangyuxin/ConvIR-B/runs/generic_run_monitoring_validation_20260716' OUTPUT_PATH='$OUTPUT_PATH' RUN_ID='candidate-33a772268-r3' OUTPUT_ID='candidate-33a772268-r3' GPU='' bash '$REMOTE_REPO/$RUNNER' >>'$OUTPUT_PATH/launch.log' 2>&1"
trap - ERR
