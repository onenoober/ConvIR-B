...
SUMMARY_FILENAME = "reside_sots_indoor_pixel_registration_qualification_v2_summary.json"
REVIEW_FACTS_FILENAME = (
    "reside_sots_indoor_pixel_registration_qualification_v2_review_facts.json"
)
...
def run(context_path: Path) -> None:
    ...
    summary: dict[str, Any] = {
        ...
        "marker": "RESIDE_SOTS_INDOOR_PIXEL_REGISTRATION_QUALIFICATION_V2_COMPLETE",
    }
