...
def finalize(
    ...
    summary = {
        ...
        "measurement_contract": {
            ...
            "nested_repeats": "four observed haze conditions, tiles, pixels, grid origins, and metrics never increase n",
        },
        "primary_regret": {
        ...
        "controls": {
            ...
            "source_grid_projection_complete_all": all(
                scene["source_grid_projection_complete"] for scene in scenes
            ) if scenes else False,
    ...
    rows = [
        {
            "estimand": "scene_mean_worst_held_out_grid_conditional_regret_psnr_db",
