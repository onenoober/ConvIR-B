...
ROUTE_ID = "daytime-dehazing-local-restoration-need-qualification-v2"
OPERATION_ID = "DAYTIME_DEHAZING_LOCAL_RESTORATION_NEED_QUALIFY"
SUMMARY_NAME = "daytime_dehazing_local_restoration_need_v2_summary.json"
SCENE_METRICS_NAME = "daytime_dehazing_local_restoration_need_v2_scene_metrics.csv"
GATE_NAME = "daytime_dehazing_local_restoration_need_v2_gate_summary.json"
REVIEW_FACTS_NAME = "daytime_dehazing_local_restoration_need_v2_review_facts.json"
...
def analyze_scene(
    ...
    input_parts = ["local-restoration-need-v2", dataset, scene]
    expected_shape = None
    inference_records = []
...
def contract(context_path: Path) -> None:
    ...
    for index in range(PROBE_ITERATIONS):
        ...
        write_contract_progress(
            ...
            stage="synthetic_full_image_official_inference_and_local_measurement",
        )
...
def run(context_path: Path) -> None:
    ...
    terminal_summary(context, gate_outcomes, {
        ...
        "marker": "DAYTIME_DEHAZING_LOCAL_RESTORATION_NEED_V2_COMPLETE",
    }, rows)
    write_gate_result(
        context,
        gate_outcomes=gate_outcomes,
