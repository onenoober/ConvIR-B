...
| Haze4K DTA-v3.7 U-TQS-Mix | D3 TAU real soft-blend oracle completed; no formal promotion yet | Phase A passed soft-oracle headroom; Phase B/B2 deployable table policies strict-failed; Phase C1 real soft-blend oracle passed. Phase D1 integrated T/A/U staged screen was mechanism-positive but raw candidates failed tail/mean gates. Phase D2 showed D1 table-oracle headroom but deployable policy strict-failed. Phase D3 rendered actual D1 quick5full tensor blends and strict-passed the oracle (`22/24` rows; best `A0_U3_U2_U1_micro_shrink/max_dpsnr` mean `+0.136562`, hard `+0.120391`, positive `0.7071`, worst `0/600`). | `PHASE_D3_TAU_REAL_BLEND_ORACLE_PASS_LOCKED_TEST_UNTOUCHED`; do not run raw D1 full `5x3` or locked test. Continue immediately with deployable high-positive utility policy modeling over the D1/D3 action bank; do not return to hard-reject threshold search. | [card](experiment_cards/2026-06-13-haze4k-dta-v3-7-u-tqs-mix.md) | [logs](experiment_logs/haze4k_dta_v3_7_u_tqs_mix_20260613/) | `github/codex/haze4k-dta-v3-7-u-tqs-mix` |
