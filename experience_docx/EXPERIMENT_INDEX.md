...
| CHD-RM v4a-A1X exact-half deployable-input accessibility | Planned; R2 identity/evidence sync complete | Frozen non-candidate diagnostic contract with global nonlinear `A1X_ACCESS_*` mapping over inference-eligible exact-half inputs; no A1X data, cloud runtime, candidate selection, canary, or locked-test access occurred. | `V4A_A1X_EXACT_HALF_DEPLOYABLE_INPUT_ACCESSIBILITY_DIAGNOSTIC_JUSTIFIED`; R1 remains blocked pending a separate R3 review and authorization. | [card](experiment_cards/2026-07-15-haze4k-v5-v4a-a1x-exact-half-deployable-accessibility.md) | [logs](experiment_logs/haze4k_v5_chd_rm_v4a_a1x_exact_half_deployable_accessibility_20260715/) | `codex/haze4k-v5-v4a-a1x-exact-half-accessibility-20260715` |
