...
| Haze4K DTA-v3.7 U-TQS-Mix | D4 high-positive policy completed; no formal promotion yet | Phase A passed soft-oracle headroom; Phase C1 and D3 actual real-blend oracles passed. D1 integrated T/A/U candidates are mechanism-positive, and D3 confirmed actual D1 micro-shrink oracle headroom (`22/24` strict rows; best mean `+0.136562`, hard `+0.120391`, positive `0.7071`, worst `0/600`). D4 deployable high-positive ridge policy strict-failed (`0/75` rows; best mean `+0.003344`, positive `0.1588`, worst `0/600`), so ranking/forcing positives remains the bottleneck. | `D4_HIGH_POSITIVE_POLICY_STRICT_FAIL_LOCKED_TEST_UNTOUCHED`; do not run raw D1 full `5x3` or locked test. Continue with targeted-intervention D5 policy over the D1/D3 action bank; do not return to hard-reject threshold search. | [card](experiment_cards/2026-06-13-haze4k-dta-v3-7-u-tqs-mix.md) | [logs](experiment_logs/haze4k_dta_v3_7_u_tqs_mix_20260613/) | `github/codex/haze4k-dta-v3-7-u-tqs-mix` |
