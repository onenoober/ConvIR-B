...
| [NoPost feature lowband routes](family_summaries/nopost_lowband_family_summary.md) | WLDB-A, v2.18 global pooled WLDB-A2, v2.19 O2 final-only spatial, and v2.20 O3 mid+final/global-context predictor forms are not training-authorized. O3 context made actions more learnable, but P1-B safety still failed. | Reopen only with a new route that materially fixes safety/no-op calibration and tail preservation before training; mean or hard-bucket movement alone is not enough. |
