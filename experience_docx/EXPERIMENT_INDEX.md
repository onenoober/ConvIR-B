...
| DTA-v2 calibrated confidence-gated adapter | Scout5 controls done; OOF20 next | Audit/preflight passed. Adapter-only fold0 scout5 on 128 internal-val images completed for invert/normal/shuffle/zero: mean dPSNR `+0.0589/+0.0642/+0.0355/+0.0243`; hard dPSNR `+0.0356/+0.0420/-0.0132/-0.0281`. Mechanism attribution remains open because wrong raw orientation slightly exceeds calibrated invert on the small scout. | `IN_PROGRESS_SCOUT5_CONTROLS_DONE_OOF20_RUNNING_NEXT`; run all real audit/preflight/training/eval on `convir-4090`, sync text evidence after every stage, and keep locked test blocked until one fixed internal-selected config. | [card](experiment_cards/2026-06-11-haze4k-dta-v2-calibrated.md) | [logs](experiment_logs/haze4k_dta_v2_calibrated_20260611/) | `github/codex/haze4k-dta-v2-calibrated` |
