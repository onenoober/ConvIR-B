...
| [StrongExpert-GainMix](family_summaries/strongexpert_gainmix_family_summary.md) | v2.1 sealed C10 `riskcap36_no075` passed formal 5x3 but failed its single locked one-shot: locked mean `+0.290049`, hard `+0.121385`; no locked-informed tuning is allowed. v2.2 C8-Mini then ran a train-derived multi-expert complementarity proof with WDMamba, FSNet+UDP, and MB-TaylorFormerV2-L; S3 oracle gain over S0 is mean `+3.158518 dB`, hard-bottom25 `+4.559721 dB`, selected severe `0`, group-min mean/hard gain `+1.559336/+1.966238 dB`. | v2.1 decision remains `LOCKED_ONE_SHOT_FAIL_NO_TUNING`; v2.2 C8 decision is `C8_PASS_COMPLEMENTARITY_PROVEN_AUTHORIZE_C9_ROUTER_DESIGN_ONLY`. Next work may design train-derived C9 low-capacity group-min router, but locked test, distillation, and locked-informed tuning remain forbidden. |
