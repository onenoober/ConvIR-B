...
- `github/codex/haze4k-dta-v3-7-u-tqs-mix`: active DTA U-TQS-Mix route;
  ...
  D7 fixed confirmation sealed the staged primary policy candidate, D8 fixed
  formal confirmation strict-passed the broader train-derived scope, and D9
  one-shot locked confirmation failed promotion. Do not tune anything from the
  locked feedback.
...
| `experiment_logs/haze4k_dta_v3_7_u_tqs_mix_20260613/` | 375+ | DTA-v3.7 U-TQS-Mix route README, convir-4090 Phase A/B/B2/C1/D1-D9 scripts/status/logs, positive-loss budget, soft action-bank oracle grids, false reject/accept taxonomy, feature ablation AUC reports, T/A/Q/U preflight JSON, image quality feature table, TAU staged-screen evidence, D2-D6 nested policy reports, D6 output-difference feature-group summary, D7 fixed-policy confirmation summary, D8 fixed formal closeout artifacts, and D9 locked one-shot summary/aggregate/per-outer evidence. Large raw D6/D7/D8/D9 feature or selected-action tables remain cloud-only runtime artifacts by default. |
