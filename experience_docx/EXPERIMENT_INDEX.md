...
| Haze4K DTA-v3 DAPC fine-tune | DTA-v3.2 SafeMix scout completed | `convir-4090` preflight passed and deterministic eval shuffle was fixed. R0 routes failed. Tail-lite `wg18_base_s008_b14` kept true-depth mechanism surplus but failed SSIM/tail. DTA-v3.1 confirmed output semantics and ruled out GT-A as rescue. DTA-v3.2 audits ruled out alpha-only shrink and justified SafeMix. SafeMix C1/C3 fold0 scouts completed: C3 fallback-A is best with mean `+0.031636`, true-vs-zero `+0.039813`, true-vs-shuffle `+0.034174`, true-vs-normal `+0.035193`, and worst `48/600`, but hard `+0.009309`, dSSIM `-0.00002288`, and positive ratio `0.6133` still fail. | `SCOUT_GATE_FAIL_LOCKED_TEST_BLOCKED`; no 5-fold x 3-seed and no locked test from C1/C3. | [card](experiment_cards/2026-06-11-haze4k-dta-v3-dapc.md) | [logs](experiment_logs/haze4k_dta_v3_dapc_20260611/) | `github/codex/haze4k-dta-v3-dapc-finetune` |
