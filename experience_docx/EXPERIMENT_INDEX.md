...
| Haze4K DTA-v3.7 U-TQS-Mix | D1 integrated T/A/U staged screen completed; no formal promotion yet | Phase A passed soft-oracle headroom; Phase B/B2 deployable table policies strict-failed; Phase C1 real soft-blend oracle passed. Phase D1 then completed the intended staged screen (`3` variants x folds `0,1` x seeds `3407/3411`) after GPU/OOM repairs. D1 is mechanism-positive but not promotion-ready: `u1` mean `+0.069596`, hard `+0.076433`, dSSIM `+0.00000786`, positive `0.6412`, worst `68.75/600`; `u2` mean `+0.059690`, hard `+0.067173`, positive `0.6408`, worst `57.25/600`; `u3` mean `+0.048004`, hard `+0.054895`, positive `0.6346`, worst `49.00/600`. | `D1_STAGE_SCREEN_TRIAGE_COMPLETE_NO_FORMAL_PROMOTION_YET_LOCKED_TEST_UNTOUCHED`; do not run raw D1 full `5x3` or locked test. Continue with deployable U-TQS soft-mix/shrink policy using D1 evidence plus action-bank headroom; do not return to hard-reject threshold search. | [card](experiment_cards/2026-06-13-haze4k-dta-v3-7-u-tqs-mix.md) | [logs](experiment_logs/haze4k_dta_v3_7_u_tqs_mix_20260613/) | `github/codex/haze4k-dta-v3-7-u-tqs-mix` |
