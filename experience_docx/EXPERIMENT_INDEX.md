...
| [StrongExpert-GainMix](family_summaries/strongexpert_gainmix_family_summary.md) | v2.1 C10 formal 5x3 passed the strong gate with sealed fixed profile `riskcap36_no075`: mean `+0.336806 +/- 0.003559`, hard `+0.326644 +/- 0.015142`, easy `+0.406808 +/- 0.018984`, positive `0.797778 +/- 0.003928`, dSSIM `+0.00023458`, severe `39.6667 +/- 2.4944/600`, max seed severe `43/600`; locked remained untouched through C10. | Exactly one locked-test run is authorized for the sealed C10 `riskcap36_no075` policy family after evidence sync/push. Locked feedback cannot tune thresholds, profiles, features, action sets, checkpoints, or distillation targets. Distillation remains blocked until locked evidence is synced and reviewed. |

## Route Summary

| Route | Status | Main result | Decision | Card | Evidence root | Source after cleanup |
| --- | --- | --- | --- | --- | --- | --- |
| Haze4K v2.1 SEG-Mix Multi-Alpha / Local-Alpha C5-C10 | C10 formal strong gate pass; locked one-shot authorized | C5 forensic, C6 multi-alpha, C7 patch oracle, C7b local-alpha, C7c risk tightening, C9 shifted stress, C9b fixed conservative stress, and C10 formal 5x3 are complete. The sealed C10 `riskcap36_no075` policy passed all seeds: mean `+0.336806 +/- 0.003559`, hard `+0.326644 +/- 0.015142`, easy `+0.406808 +/- 0.018984`, positive `0.797778 +/- 0.003928`, dSSIM `+0.00023458`, severe `39.6667 +/- 2.4944/600`, max seed severe `43/600`; locked was untouched. | `C10_FORMAL_5X3_STRONG_PASS_AUTHORIZE_LOCKED_ONE_SHOT`; run exactly one locked test for the sealed C10 `riskcap36_no075` policy after evidence sync/push. Do not tune from locked output; distillation remains blocked until locked evidence is synced and reviewed. | [card](experiment_cards/2026-06-15-haze4k-v2-1-segmix-multialpha-local.md) | [logs](experiment_logs/haze4k_v2_1_segmix_multialpha_local_20260615/) | `github/codex/haze4k-v2-1-segmix-multialpha-local` |
