...
| [NoPost feature lowband routes](family_summaries/nopost_lowband_family_summary.md) | v2.21 fixed OOF safety replay passed and v2.22 gated-lowband N3 microfit passed stability review, but neither is a quality/promotion win. The current bottleneck is still OOF train-derived safety/no-op action control under real training, with locked test blocked. | Reopen only through a separately reviewed OOF train-derived route that preserves v2.21 safety calibration and v2.22 microfit stability while materially improving quality beyond near-identity. |
