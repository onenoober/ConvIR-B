...
| Haze4K DTA-v3.7 U-TQS-Mix | Phase B table-only TQS completed; strict fail | Phase A passed soft-oracle headroom (`13/18` strict rows; best oracle mean `+0.143298`, positive ratio `0.6623`, worst `0/600`). Phase B nested ridge TQS over current deployable table features completed on `convir-4090` with `strict_pass=0`. Best deployable group `T_pred` controlled tail (`worst 0.80/600`, max outer `2.33/600`) and positive ratio (`0.6360`) but collapsed gain (mean `+0.015792`, hard `+0.013137`, dSSIM `-0.00000566`) and failed true-vs-controls. | `PHASE_B_TABLE_POLICY_STRICT_FAIL_NEEDS_FEATURE_ENRICHMENT_OR_REAL_BLEND`; continue v3.7 via T/A/Q/U feature enrichment and real soft-blend verification; do not return to v3.6 hard-reject threshold search. | [card](experiment_cards/2026-06-13-haze4k-dta-v3-7-u-tqs-mix.md) | [logs](experiment_logs/haze4k_dta_v3_7_u_tqs_mix_20260613/) | `github/codex/haze4k-dta-v3-7-u-tqs-mix` |
...
| `experiment_logs/haze4k_dta_v3_7_u_tqs_mix_20260613/` | 18 | DTA-v3.7 U-TQS-Mix route README, convir-4090 Phase A/B scripts/status/logs, positive-loss budget, soft action-bank oracle grid, false reject/accept taxonomy, feature ablation AUC report, T/A/Q/U preflight JSON, Phase A summary, nested TQS policy reports, aggregate/action tables, and TQS summary. |
