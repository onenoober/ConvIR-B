...
| [Depth-transmission adapters](family_summaries/dta_family_summary.md) | DTA-v2 was positive but not depth-attributed enough. DTA-v3 R0 failed. DTA-v3.1 airlight/risk/light-hinge failed. DTA-v3.2 C3 improved SafeMix tail to `48/600` but failed hard/SSIM/positive-ratio gates. DTA-v3.3 RouterFusion triage failed. DTA-v3.4 FDF-TSR proved depth attribution but over-acted: positive ratio stayed `0.579-0.590` and worst stayed `116-128/600`. DTA-v3.5 FDF-RCS-Lite completed relaxed train-derived diagnostics: conservative FDF raised positive ratio to about `0.625-0.631`, reduced worst to `60.5-82.5/600`, and produced a strong oracle risk-coverage curve, but strict all-image/selector gates still failed. | Do not launch 5-fold x 3-seed formal validation from B0-B4/C/D/E/L rows, and do not run locked Haze4K test from v3.4/v3.5. Reopen only with a stronger nested selector/calibration route or a materially safer feature-action candidate. |
