...
| Haze4K v2.21 NoPost safety-calibrated lowband replay | Completed gate-pass review-only | v2.20 raw O3 action still failed safety (`p05 -0.7040`, CVaR5 `-1.4501`, severe `11.00%`, strong-reference regression `25.17%`). Train-derived safety controller `V221_risk_temperature_gamma0p50` passed fixed OOF replay gates: mean `+2.2270 dB`, hard `+4.3031 dB`, easy `+0.7403 dB`, p05 `-0.0025`, CVaR5 `-0.2089`, severe `1.79%`, strong-reference regression `4.83%`, fold tail pass `5/5`. Factorial A/B/C/D passed; P2 ROC AUC `0.9239`; P3 still reports `43/2400` post-gate severe residual cases. | `V221_P1_REPLAY_GATE_PASS_REVIEW_N3_MICROFIT_ROUTE_CARD_NO_TRAINING_LAUNCHED`; write a separate N3 microfit route card, do not auto-train, and locked test remains blocked. | [card](experiment_cards/2026-07-04-haze4k-v2-21-nopost-safety-calibrated-lowband-replay.md) | [logs](experiment_logs/haze4k_v2_21_nopost_safety_calibrated_lowband_replay_20260704/) | `codex/haze4k-v2-21-nopost-safety-calibrated-lowband-replay` |
