...
| Haze4K DTA-v3 DAPC fine-tune | DTA-v3.3 RouterFusion triage planned | `convir-4090` preflight passed and deterministic eval shuffle was fixed. R0 routes failed. DTA-v3.2 C3 fallback-A is best so far with mean `+0.031636`, true-vs-zero `+0.039813`, true-vs-shuffle `+0.034174`, true-vs-normal `+0.035193`, and worst `48/600`, but hard `+0.009309`, dSSIM `-0.00002288`, and positive ratio `0.6133` still fail. DTA-v3.3 now adds image/patch RouterFusion, low-phys/high-learned SafeMix, SSIM-CVaR/group-tail loss, counterfactual gate suppression, and a fold0/fold1 x seeds `3407/3411` triage queue before any formal validation. | `PLANNED_ROUTERFUSION_TRIAGE_CODE_READY_LOCKED_TEST_BLOCKED`; no formal 5-fold x 3-seed and no locked test unless a fixed D-row passes triage. | [card](experiment_cards/2026-06-11-haze4k-dta-v3-dapc.md) | [logs](experiment_logs/haze4k_dta_v3_dapc_20260611/) | `github/codex/haze4k-dta-v3-dapc-finetune` |
