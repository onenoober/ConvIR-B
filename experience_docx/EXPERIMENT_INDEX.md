...
| Haze4K v2.34 NoPost Teacher-Delta Projection and Multi-Stage Bridge Audit | Completed P0/P0B diagnostic; free-tensor projection blocked; locked test blocked | P0 exactly rechecked the v2.33 first32 canary and confirmed the coverage anomaly: direct WDMamba-alpha0.5 mean/hard/easy deltas were `-2.3193/-1.5978/-2.1668 dB`, P1 table join was missing for `25/32`, P4 eligible coverage was `5/32`, and recomputation matched v2.33 P4 teacher-blend deltas (`mean_abs_delta_diff=0.0`). P0B rebuilt a table-positive balanced canary; hard direct benefit became positive (`+0.6788 dB`) and eligible coverage was `7/32`, but mean/easy stayed strongly negative (`-2.4753/-4.0017 dB`) with p05/CVaR5 `-8.7433/-11.4269 dB`. | `P0B_FAIL_BALANCED_CANARY_DIRECT_TEACHER_GATE`; do not run P1 free-tensor projection, P2 generator gap, P3 gradient conflict, P4 bridge micro-canary, canary80, or locked test from these crop-misaligned teacher canaries. | [card](experiment_cards/2026-07-06-haze4k-v2-34-nopost-teacher-delta-projection-and-multistage-bridge-audit.md) | [logs](experiment_logs/haze4k_v2_34_nopost_teacher_delta_projection_and_multistage_bridge_audit_20260706/) | `github/codex/haze4k-v2-34-nopost-teacher-delta-projection-and-multistage-bridge-audit` |
...
| `experiment_logs/haze4k_v2_34_nopost_teacher_delta_projection_and_multistage_bridge_audit_20260706/` | 17 | v2.34 NoPost teacher-delta projection audit README, route scripts, status/logs, P0 first32 mask/join/direct teacher audit, P0B table-positive balanced canary manifest and direct teacher audit, decision tree, and closeout JSON. P0/P0B failed direct teacher gates, so P1 free-tensor projection and later phases were not launched. |
