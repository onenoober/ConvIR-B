...
| `experiment_logs/haze4k_v2_33_nopost_teacher_benefit_source_and_bilfcf_trainability_audit_20260705/` | 39 | v2.33 NoPost teacher-benefit source and BILFCF trainability audit README, P0 contract reports, P1 teacher-source tables, P2 crop-aligned loss/gradient/scale sanity tables, P3 insertion Jacobian sensitivity tables, P4 masked teacher-benefit canary32 report/per-image table, closeout JSON, durable cloud scripts, status, and logs. P4 failed gate, so canary80 and locked test were not launched. |
