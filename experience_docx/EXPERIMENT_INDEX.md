...
| Haze4K DTA-v3.7 U-TQS-Mix | Phase A table-only complete; soft-oracle pass | Phase A on `convir-4090` consumed `27000` v3.6 formal OOF rows and produced the required budget, soft-oracle, taxonomy, AUC, and T/A/Q/U preflight artifacts. `13/18` soft-oracle rows strict-pass. Best `A0_L2_L3_L1_full` oracle has mean `+0.143298`, hard `+0.121101`, dSSIM `+0.00002551`, positive ratio `0.6623`, worst `0/600`, and max outer worst `0/600`. v3.6 hard reject is over positive-loss budget (`L3 32.73/600`, `8.77x`). | `PHASE_A_PASS_SOFT_ORACLE_HEADROOM`; proceed to Phase B TQS gain-risk predictor and real soft-blend verification; current deployable severe AUC is weak (`~0.608`), so T/A/Q/U feature enrichment is required before formal policy claims. | [card](experiment_cards/2026-06-13-haze4k-dta-v3-7-u-tqs-mix.md) | [logs](experiment_logs/haze4k_dta_v3_7_u_tqs_mix_20260613/) | `github/codex/haze4k-dta-v3-7-u-tqs-mix` |
...
| `experiment_logs/haze4k_dta_v3_7_u_tqs_mix_20260613/` | 11 | DTA-v3.7 U-TQS-Mix route README, convir-4090 Phase A prepare/status/log, positive-loss budget, soft action-bank oracle grid, false reject/accept taxonomy, feature ablation AUC report, T/A/Q/U preflight JSON, and Phase A summary. |
