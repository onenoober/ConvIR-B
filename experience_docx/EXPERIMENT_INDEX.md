...
| --- | --- | --- |
| [External dehazing reproductions](family_summaries/external_dehazing_reproduction_summary.md) | DehazeFormer cloud engineering smoke passed with random weights; official quality evaluation is pending the user-supplied checkpoint. | Run the fixed official `test.py` path with the official checkpoint and a complete filename-aligned test tree. |
