...
| [External AECR-Net / FFA-Net reproduction](family_summaries/external_dehazing_reproduction_summary.md) | Engineering smoke passed for both on a Haze4K training crop; no pretrained or PSNR/SSIM claim. | Provenance-check user-provided weights, or predeclare a full Haze4K training/validation protocol. |

## Route Summary

| Route | Status | Main result | Decision | Card | Evidence root | Source after cleanup |
| --- | --- | --- | --- | --- | --- | --- |
| AECR-Net and FFA-Net engineering reproduction | Cloud smoke passed | Both used 3000/3000 Haze4K train pairs; finite `1x3x64x64` forward/backward, one Adam step, strict checkpoint reload; locked test untouched. | `COMPLETED_GATE_PASS` for engineering only; no pretrained or quality reproduction claim. | [card](experiment_cards/2026-09-21-aecr-ffa-repro.md) | [logs](experiment_logs/aecr_ffa_repro_20260921/) | `github/codex/dehaze-aecr-ffa-repro-20260921` |
