...
| Haze4K DTA-v3 DAPC fine-tune | Phase A gate failed; Phase B blocked | `convir-4090` preflight passed: A0 partial load `602` keys, DTA-only missing keys, deterministic eval shuffle audit `same_image_ratio=0.0`. Phase A R0 OOF20 fold0 completed but was negative: mean dPSNR `-0.012119`, hard bottom-25 `-0.069025`, easy top-25 `+0.044643`, mean dSSIM `-0.00001218`, positive ratio `0.45`, strong regressions `48/150`, worst regressions `70/600`. | `COMPLETED_GATE_FAIL_PHASE_A_R0_NO_PHASE_B`; do not launch Phase B from this checkpoint; locked test blocked. | [card](experiment_cards/2026-06-11-haze4k-dta-v3-dapc.md) | [logs](experiment_logs/haze4k_dta_v3_dapc_20260611/) | `github/codex/haze4k-dta-v3-dapc-finetune` |
