...
| Haze4K DTA-v3.7 U-TQS-Mix | Phase C1 real soft-blend oracle passed; integrated T/A/U next | Phase A passed soft-oracle headroom. Phase B/B2 deployable table policies strict-failed even after quality features, showing current feature separability is insufficient. Phase C1 then rendered actual tensor blends for folds `0..4` x seeds `3407/3411/2026`: `162000` selected rows, `18` grid rows, `14` strict-pass rows. Best `A0_L2_L3_L1_micro_shrink / max_dpsnr` reached mean `+0.143568`, hard `+0.121118`, dSSIM `+0.00002579`, positive ratio `0.6977`, worst `0/600`, max outer worst `0/600`, true-vs-zero `+0.106861`, true-vs-shuffle `+0.080749`, true-vs-normal `+0.088555`. | `PHASE_C1_REAL_BLEND_ORACLE_PASS`; soft action-bank/micro-shrink is validated in image space. The remaining bottleneck is deployable U-TQS gain-risk selection and integrated transmission/airlight/uncertainty supervision, not hard-reject tuning or candidate-family headroom. | [card](experiment_cards/2026-06-13-haze4k-dta-v3-7-u-tqs-mix.md) | [logs](experiment_logs/haze4k_dta_v3_7_u_tqs_mix_20260613/) | `github/codex/haze4k-dta-v3-7-u-tqs-mix` |
