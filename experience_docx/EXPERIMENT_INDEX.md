...
| Haze4K DTA-v3.6 HRCS | Phase A completed; relaxed formal queue pending | Selector-only Phase A on `convir-4090` used the v3.5 OOF action table (`15600` rows) for L1/L2/L3. Oracle high-coverage headroom is strong: L3 oracle at `0.95` coverage has mean `+0.088241`, positive ratio `0.6304`, worst `39.50/600`, strict pass. Deployable selectors are relaxed-pass but strict-fail: best L3 logistic `input_only` at coverage `0.9042` has mean `+0.067108`, positive ratio `0.5862`, worst `52.25/600`; action-bank selector has mean `+0.063409`, positive ratio `0.5833`, worst `50.25/600`. | `PHASE_A_COMPLETED_RELAXED_PASS_STRICT_FAIL_FORMAL_QUEUE_PENDING`; continue relaxed train-derived formal queue per user override, but no promotion claim and no locked-test tuning. | [card](experiment_cards/2026-06-13-haze4k-dta-v3-6-hrcs.md) | [logs](experiment_logs/haze4k_dta_v3_6_hrcs_20260613/) | `github/codex/haze4k-dta-v3-6-hrcs` |
...
| `experiment_logs/haze4k_dta_v3_6_hrcs_20260613/` | 12 | DTA-v3.6 HRCS route README, Phase A convir-4090 status/logs, high-coverage rejection curve, risk-feature AUC report, reliability bins, selector error table, action-bank oracle-vs-selector table, best configs, and selector summary JSON. |
