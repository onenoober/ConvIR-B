...
| Haze4K DTA-v3.7 U-TQS-Mix | D7 fixed output-difference policy confirmation passed on staged quick5full scope; no locked test yet | Phase A passed soft-oracle headroom; Phase C1 and D3 actual real-blend oracles passed. D1 integrated T/A/U candidates are mechanism-positive, and D3 confirmed actual D1 micro-shrink oracle headroom (`22/24` strict rows; best mean `+0.136562`, hard `+0.120391`, positive `0.7071`, worst `0/600`). D4/D5 deployable policies strict-failed, but D6 output-difference / quality features produced `8/522` strict rows. D7 froze the top D6 rows and confirmed both: primary `outputdiff_plus_Q / micro_shrink / pred_gain / target=1.00` has mean `+0.078596`, hard `+0.085328`, dSSIM `+0.00001913`, positive `0.6583`, worst `46/600`, max outer worst `52/600`; backup `outputdiff_only` has worst `44/600`. | `D7_FIXED_OUTPUTDIFF_CONFIRM_PASS_LOCKED_TEST_UNTOUCHED`; no D6/D7 active run remains. Next is broader train-derived formal confirmation of the sealed primary policy; locked test remains blocked until that passes. | [card](experiment_cards/2026-06-13-haze4k-dta-v3-7-u-tqs-mix.md) | [logs](experiment_logs/haze4k_dta_v3_7_u_tqs_mix_20260613/) | `github/codex/haze4k-dta-v3-7-u-tqs-mix` |
