...
| --- | --- | --- |
| Before task execution or after a scope change | `MODEL_AGENT_COST_ROUTING_PROTOCOL.md` | task class, minimum qualified model role, single-model execution by default, and a bounded handoff only when escalation or optional dispatch is justified |
