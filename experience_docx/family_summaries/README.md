...
| CHD-RM v5 route chain | [index](../CHD_RM_EXPERIMENT_INDEX.md) | v3l closed after confirming large oracle safe-step upside but weak transmission-only risk observability; no canary is authorized without stronger deployable risk signal and a new sealed split. |
