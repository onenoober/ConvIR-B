...
Status: compact AI-readable route summary through SafeRHFD-v2.

## Purpose

This package is the shortest current entry point for reading the Haze4K route
sequence without checking every branch. It summarizes completed route decisions
through PFD mainline, B1 surgery, and SafeRHFD-v2, then points back to the
central index and full text evidence.
