...
def main(args):
    ...
    if args.arch == 'sfad_sdfm':
        model = build_sfad_sdfm_net(args.version, args.data, args.fam_mode)
    else:
    ...
    if args.arch == 'sfad_sdfm' and args.mode == 'train':
...
if __name__ == '__main__':
    ...
    parser.add_argument('--arch', default='official_convir', choices=['official_convir', 'convir', 'sfad_sdfm'], type=str)
    ...
    if args.arch not in ('official_convir', 'convir', 'sfad_sdfm'):
    ...
    if not os.path.exists(args.model_save_dir):
        os.makedirs(args.model_save_dir)
    for source in ('models/layers.py', 'models/ConvIR.py', 'models/SFADConvIR.py', 'data/data_load.py', 'data/data_augment.py', 'train.py', 'valid.py', 'eval.py', 'main.py'):
